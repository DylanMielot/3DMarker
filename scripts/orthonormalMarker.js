...
const dustTexture = textureLoader.load("../images/circle.png")
...
export class Marker{
    ...
    createPoints(){
        ...
        // CREATION DES POINTS
        console.log("Création des points")
    ...
    setEquation(equation){
        ...
        // MAJ EQUATION
        console.log("Mise à jour de l'équation")
    ...
    updateMarker(){
        ...
        // MAJ DU REPERE
        console.log("Mise à jour du repère")
